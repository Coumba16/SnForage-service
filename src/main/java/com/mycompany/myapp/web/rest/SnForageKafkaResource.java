...
@RestController
@RequestMapping("/api/sn-forage-kafka")
public class SnForageKafkaResource {
    private final Logger log = LoggerFactory.getLogger(SnForageKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SnForageKafkaResource(KafkaProperties kafkaProperties) {
